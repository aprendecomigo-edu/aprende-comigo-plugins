...
Dispatch code-quality-reviewer subagent to catch issues before they cascade.
...
Use Task tool with code-quality-reviewer type, fill template at `code-reviewer.md`
